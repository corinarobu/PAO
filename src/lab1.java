...
class ArraysOther{
    public static void main(String[] args){
        ...
        System.out.println(Arrays.mismatch(a,b)); //-1 daca sunt identice, sau indicele la care incep sa difere
        System.out.println(Arrays.compare(a,b)); // 0 daca sunt egale
    }
}
...
class Copy {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(w)); // pe pune pe toate si completeaza cu 0 pana face 8 elemente in total
    }
}
